...
//import './About.css';
import backgroundImage from '../images/Screenshot 2025-02-09 173653.png'; // Import the image
  ...
  return (
    <div className="about-page" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className="about-content">
        ...
        <ul>
          <li><strong>Genetic Mutations:</strong> Investigating specific changes in DNA that increase cancer risk.</li>
          <li><strong>Hereditary Cancer Syndromes:</strong> Studying inherited genetic mutations passed down through families.</li>
          <li><strong>Targeted Therapies:</strong> Developing treatments that specifically target genetic alterations in cancer cells.</li>
        </ul>
        <h2>Importance of Genetic Oncology</h2>
        <p>Understanding the genetic basis of cancer can lead to:</p>
        <ul>
